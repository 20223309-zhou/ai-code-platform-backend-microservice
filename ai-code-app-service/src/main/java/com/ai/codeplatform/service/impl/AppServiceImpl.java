...
import com.ai.codeplatform.ai.model.entity.ChatHistoryOriginal;
import com.ai.codeplatform.ai.model.entity.User;
import com.ai.codeplatform.ai.model.enums.ChatHistoryMessageTypeEnum;
import com.ai.codeplatform.ai.model.enums.CodeGenTypeEnum;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public App createApp(AppAddRequest appAddRequest, HttpServletRequest request, String initPrompt) {
        ...
        for (int i = 0; i < maxRetry; i++) {
            ...
            success = userService.deductQuota(currentUser.getId(), currentQuota);
